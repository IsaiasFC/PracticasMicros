...
#define LCD_RD7     PORTCbits.RC3       // D7 estara en C3
#define TRISRD7     TRISCbits.TRISC3    //TRISCbits.TRISC3

#define LCD_RD6     PORTCbits.RC2       // D6 estara en C2
#define TRISRD6     TRISCbits.TRISC2

#define LCD_RD5     PORTCbits.RC1       // D5 estara en C1
#define TRISRD5     TRISCbits.TRISC1

#define LCD_RD4     PORTCbits.RC0       // D4 estara en C0
#define TRISRD4     TRISCbits.TRISC0

#define LCD_EN      PORTAbits.RA7      // EN estara en A7
#define TRISEN      TRISAbits.TRISA7

#define LCD_RS      PORTAbits.RA6       // RS estara en A6
#define TRISRS      TRISAbits.TRISA6
