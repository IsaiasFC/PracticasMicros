...
#define LCD_RD7     PORTCbits.RC1       // D7 estara en C1
#define TRISRD7     TRISCbits.TRISC1    //TRISCbits.TRISC1

#define LCD_RD6     PORTCbits.RC2       // D6 estara en C2
#define TRISRD6     TRISCbits.TRISC2

#define LCD_RD5     PORTDbits.RD0       // D5 estara en D0
#define TRISRD5     TRISDbits.TRISD0

#define LCD_RD4     PORTDbits.RD1       // D4 estara en D1
#define TRISRD4     TRISDbits.TRISD1

#define LCD_EN      PORTDbits.RD3       // EN estara en D3
#define TRISEN      TRISDbits.TRISD3

#define LCD_RS      PORTDbits.RD2       // RS estara en D2
